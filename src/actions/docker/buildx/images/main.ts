...
import { catchErrorAndSetFailed, handleSuccess, parseFormattedString } from '../../../../libs/utils';
...
export async function run(): Promise<void> {
  try {
    ...
    const manifestMetaAnnotationsInput = core.getInput('manifestMetaAnnotations', { required: true });
    ...
    const inspectService = DockerBuildXImageToolsBuilder.forInspect()
      .withSource(imageUri)
      .build();
