...
const DEFAULT_APPROVED_WORDS = ["approved", "approve", "lgtm", "yes"];
const DEFAULT_DENIED_WORDS = ["denied", "deny", "no"];
...
class DeploymentGateRunner extends RunnerBase {
...
export { Octokit as O, createDeploymentGateRunner as c };
