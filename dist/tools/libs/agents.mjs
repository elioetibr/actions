import { i as __require, t as __commonJSMin } from "./rolldown-runtime.mjs";
	...
	async exec(command, args = [], options = {}) {
		...
		return {
			exitCode: await exec(command, args, {
				...
				...options.silent !== void 0 ? { silent: options.silent } : {},
...
//#endregion
export { warning as a, info as i, debug as n, require_undici as o, error as r, require_tunnel as s, createGitHubActionsAgent as t };
