...
import { ITerraformProvider, TerraformCommand } from './ITerraformProvider';
/**
 * Service interface for Terraform operations
 * Extends ITerraformProvider with modification and command generation methods
 */
export interface ITerraformService extends ITerraformProvider, IStringListProvider {
    /**
...
//# sourceMappingURL=ITerraformService.d.ts.map